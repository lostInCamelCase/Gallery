...
const TitleView = ({stayName, rating, showShare, showSave}) => {
  ...
  if (rating.superHost === 'host') {
    ...
    <div className={styles.star}><i className="fas fa fa-star"></i></div>
    <div className={styles.medal}><i className="fas fa fa-medal"></i></div>
    ...
    <div className={styles.save} onClick={showSave}><i className="far fa fa-heart"></i> Save</div>
  </div>
  )};
